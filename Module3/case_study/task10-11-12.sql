...
select hd.id_hop_dong,nv.ho_ten as 'ten_nhan_vien',kh.ho_ten as 'ten_khach_hang',kh.sdt,dv.ten_dich_vu,
count(hdct.id_hop_dong_chi_tiet) as 'so_luong_dvdk',hd.ngay_lam_hop_dong,hd.tien_dat_coc
from hop_dong hd
